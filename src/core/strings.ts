...
const en: Strings = {
  ...
  alreadyAProject: "There is already a vibecrew project in this folder.",
  alreadyAProjectHint: "Run  vibecrew status  to see it, or start somewhere else.",
  ...
  noToolsHint: "Run  vibecrew doctor  to see why.",
  carryingOnAnyway:
  ...
  nodeTooOld: (version) => `Node ${version} is older than vibecrew needs. Install Node 20 or newer.`,
  noToolAtAll: "No AI coding tool is usable, so vibecrew cannot plan your project properly.",
  runDoctorAgain: "Fix one of the warnings above, then run  vibecrew doctor  again.",
  readyToBuild: "You are ready to build.",
  initExample: 'vibecrew init "what you want to build"',
  apiKeyLabel: "your Anthropic API key",
  claudeMissing:
    "No command-line Claude Code here. Being signed in to the Claude app is not the same thing -- vibecrew drives the one your terminal can run.",
  claudeMissingFix:
  ...
  codexMissing:
    "No command-line Codex here. Codex inside the ChatGPT app is a different thing -- vibecrew drives the one your terminal can run.",
  ...
  notAProject: "This folder is not a vibecrew project yet.",
  notAProjectHint: 'Make one here with:  vibecrew init "what you want to build"',
  claudeMdIntro:
  ...
  generatedBy: "Generated by vibecrew",
  doNotEditByHand:
...
const ko: Strings = {
  ...
  alreadyAProject: "이 폴더에는 이미 vibecrew 프로젝트가 있습니다.",
  alreadyAProjectHint: "vibecrew status 로 확인하시거나, 다른 폴더에서 시작하세요.",
  ...
  noToolsHint: "vibecrew doctor 를 실행하면 이유를 알려줍니다.",
  carryingOnAnyway:
  ...
  nodeTooOld: (version) => `Node ${version}은 vibecrew에 필요한 버전보다 낮습니다. Node 20 이상을 설치하세요.`,
  noToolAtAll: "쓸 수 있는 AI 코딩 도구가 없어서, 아이디어에 맞는 계획을 짤 수 없습니다.",
  runDoctorAgain: "위 경고 중 하나를 해결한 뒤 vibecrew doctor 를 다시 실행하세요.",
  readyToBuild: "이제 만들 준비가 됐습니다.",
  initExample: 'vibecrew init "만들고 싶은 것"',
  apiKeyLabel: "내 Anthropic API 키",
  claudeMissing:
    "터미널에서 쓸 수 있는 Claude Code가 없습니다. Claude 앱에 로그인한 것과는 별개입니다 — vibecrew는 터미널이 실행할 수 있는 쪽을 씁니다.",
  claudeMissingFix:
    "Claude Code를 설치한 뒤 터미널을 닫았다 다시 여세요. `claude` 명령이 잡혀야 합니다.",
  claudeLoginUnknown: "Claude Code가 설치돼 있습니다. 로그인 여부는 실제로 쓸 때 확인합니다.",
  codexMissing:
    "터미널에서 쓸 수 있는 Codex가 없습니다. ChatGPT 앱 안의 Codex는 다른 물건입니다 — vibecrew는 터미널이 실행할 수 있는 쪽을 씁니다.",
  ...
  notAProject: "이 폴더는 아직 vibecrew 프로젝트가 아닙니다.",
  notAProjectHint: '여기에 만들려면:  vibecrew init "만들고 싶은 것"',
  claudeMdIntro:
