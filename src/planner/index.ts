...
export async function createPlan(
  ...
  notes.push(
    "Built a general-purpose plan without using AI. It will work, but it does not know the details of your idea -- you can edit .vibesquad/plan.json and run again.",
  );
  return {
